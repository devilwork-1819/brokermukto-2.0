...
তবে এটি সম্ভব যে কোনো রিয়েল এস্টেট ব্রোকার বা দালাল অন্য কারো জমির তথ্য তাদের নিজস্ব মোবাইল নম্বর দিয়ে পোস্ট করতে পারে। তাই কোনো আর্থিক লেনদেন বা চুক্তিতে যাওয়ার আগে ক্রেতাদের অবশ্যই জমির মালিকানা এবং বিবরণ সঠিকভাবে যাচাই করে নেওয়ার করার পরামর্শ দেওয়া হচ্ছে।`
    ...
    },
    {
      ...
      answer: `নতুন কোনো সম্পত্তি আমাদের সিস্টেমে লিস্টিং হওয়া মাত্রই আপনার পছন্দের জেলা ও এলাকার অ্যালার্ট পেতে আপনার হোয়াটসঅ্যাপ নম্বর দিয়ে সাবস্ক্রাইব করুন। কোনো ক্রেতা রিকোয়ারমেন্ট দিলে বা বিক্রেতা নতুন বিজ্ঞাপন দিলে আমাদের সিস্টেম অবিলম্বে সম্পূর্ণ ফ্রিতে সরাসরি হোয়াটসঅ্যাপে অটোমেটেড অ্যালার্ট বার্তা পাঠায়।`
    },
    {
...
It may be possible that real estate brokers can post others' land using their mobile number. Buyers are advised to verify the same before dealing or exchange of any money.`
    ...
    },
    {
      ...
      answer: `Simply input your WhatsApp number and select your district and area on the dashboard to register for alerts. The moment a new verified property matching your district and area is posted, our system automatically triggers a free instant direct alert to your WhatsApp.`
    },
    {
...
3. Physically map out property boundaries, access roads, and check for any outstanding disputes.`
  ...
  return (
    <div id="faq-section" className="max-w-[1650px] mx-auto mt-6 mb-4 animate-fade-in font-sans px-2 sm:px-0">
      <div className="bg-[#C0DD73] border border-[#a6c359] rounded-2.5xl p-4 md:p-5 shadow-md">

        <div className="text-center space-y-1 mb-4">
          <h3 className="text-[9px] md:text-xs font-black text-[#1e3a12] uppercase tracking-widest text-center">
        ...
        <div className="space-y-2.5 max-w-full mx-auto">
          {faqs.map((faq, index) => {
            ...
            return (
              <div 
                ...
                className={`border rounded-2xl transition-all duration-200 overflow-hidden ${
                  isOpen 
                    ? 'border-[#8ea645] bg-white/45 shadow-sm' 
                    : 'border-black/5 bg-white/15 hover:bg-white/25 hover:border-black/10'
                }`}
              >
                {/* Header / Trigger */}
                <button
                ...
                >
                  <span className={`text-xs md:text-sm font-black transition-colors ${isOpen ? 'text-[#1d3e11]' : 'text-slate-900'}`}>
                    {faq.question}
                  </span>
                  <div className={`shrink-0 p-1 rounded-lg bg-black/5 text-slate-800 transition-all duration-300 ${isOpen ? 'rotate-185 bg-white/50 text-[#1d3e11]' : ''}`}>
                ...
                >
                  <div className="p-3.5 md:p-4 text-xs text-slate-800 leading-relaxed font-semibold whitespace-pre-line">
        ...
        <div className="mt-6 pt-5 border-t border-black/10 flex flex-col sm:flex-row items-center justify-between gap-4 max-w-full mx-auto">
          <div className="flex items-center gap-2.5 text-left w-full sm:w-auto">
            <div className="p-2 rounded-xl bg-orange-600/10 text-orange-950 shrink-0 border border-orange-600/20">
            ...
            <div>
              ...
              <p className="text-[9px] md:text-[10px] text-slate-700 font-bold mt-1 leading-none">
                {lang === 'bn' 
          ...
          <div className="flex items-center gap-1 text-[10px] text-[#1a380f] font-extrabold bg-[#a8c359]/20 px-2.5 py-1 rounded-full border border-[#8da544]/30">
