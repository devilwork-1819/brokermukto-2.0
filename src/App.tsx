...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Fetch freshest data from Express Server
  ...
  useEffect(() => {
    const fetchListingsPeriodically = () => {
      ...
      fetch(`/api/listings${sheetQuery}`)
        ...
        .catch(err => console.warn('[Broker Mukto Sync] Periodic listings fetch failed:', err));
    };
  ...
  useEffect(() => {
    if (view === 'listings' || view === 'home') {
      ...
      fetch(`/api/listings${sheetQuery}`)
        ...
        .catch(err => console.warn('[Broker Mukto Sync] Instant tab refresh listings failed:', err));
    }
  }, [view]);
