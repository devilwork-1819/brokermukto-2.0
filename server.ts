...
app.get("/api/listings", (req: express.Request, res: express.Response) => {
...
app.get("/api/registered-buyers", (req: express.Request, res: express.Response) => {
...
app.get("/api/buyer-leads", (req: express.Request, res: express.Response) => {
