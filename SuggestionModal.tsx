        ...
        {!isSuccess ? (
          <>
            <h3 className="text-xl font-extrabold text-yellow-500 flex items-center gap-2 mb-2" id="suggestion-modal-header">
              💡 {lang === 'bn' ? 'পরামর্শ ও মতামত বাক্স' : 'Suggestions & Improvements'}
            </h3>
            <p className="text-xs text-white/55 mb-5 font-semibold leading-relaxed">
              {lang === 'bn' 
                ? 'BrokerMukto ওটিপি সার্ভিস, পে আনলকিং বা আমাদের ওয়েবসাইট উন্নত করতে আপনার মূল্যবান মতামত জানান।' 
                : 'Share your ideas to improve BrokerMukto (OTP service, pay-to-unlock, design, or performance).'}
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4" id="visitor-suggestion-form">
              ...
              <div>
                <label className="block text-[10px] font-black uppercase tracking-wider text-yellow-500/85 mb-1.5">
                  {lang === 'bn' ? 'আপনার পরামর্শ / মতামত *' : 'Your Suggestion / Details *'}
                </label>
                <textarea 
                  required
                  rows={4}
                  ...
                  placeholder={lang === 'bn' ? 'সবচেয়ে ভালো হত যদি আমরা...' : 'It would be great if the website had...'}
              ...
              >
                ...
                <span>{lang === 'bn' ? 'মতামত জমা দিন' : 'Submit Suggestion'}</span>
              </button>
            </form>
          </>
        ) : (
          <div className="py-6 text-center space-y-4" id="suggestion-success-panel">
            ...
            <h3 className="text-lg font-black text-white">
              {lang === 'bn' ? 'ধন্যবাদ! মতামত জমা হয়েছে।' : 'Thank you for your valuable feedback!'}
            </h3>
            <p className="text-xs text-white/60 leading-relaxed max-w-xs mx-auto">
              {lang === 'bn' 
                ? 'আপনার পরামর্শ আমাদের টিম গুরুত্ব সহকারে পর্যালোচনা করবে এবং পোর্টাল উন্নত করতে সাহায্য করবে।' 
                : 'Our administrator team will review your recommendations with high priority as we grow.'}
            </p>
            <button
